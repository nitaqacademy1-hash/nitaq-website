    ...
    return (
        ...
        >
            ...
            <div className="content-card">
                ...
                <div className="overview-text">
                    <p style={{ marginBottom: '15px' }}>
                        The Reading &amp; Writing section of the Digital SAT is a single, combined module that tests your ability to comprehend passages, analyse arguments, and apply English language conventions in context. At Nitaq Academy, our Sharjah-based trainers break this section into focused skill areas to maximise your score.
                    </p>
            ...
            <div className="content-card">
                ...
                <p style={{ color: '#64748b', marginBottom: '25px' }}>Real results from real students at Nitaq Academy Sharjah.</p>
                <div className="tracks-grid">
            ...
            <div className="content-card">
                ...
                <div className="faq-accordion-group" style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
                    ...
                    <details className="faq-accordion">
                        <summary>How long does SAT preparation take at Nitaq Academy in Sharjah?</summary>
                        <div className="faq-accordion-content">
                    ...
                    <details className="faq-accordion">
                        ...
                        <div className="faq-accordion-content">
                            <p>SAT test centers in the UAE are located in Dubai and Abu Dhabi. Students from Sharjah typically travel to Dubai centers to sit the exam. Test dates are announced by the College Board several months in advance, and seats fill quickly — we recommend registering at least 6 to 8 weeks before your preferred date.</p>
                        </div>
                    </details>
                    <details className="faq-accordion">
                    ...
                    <details className="faq-accordion">
                        <summary>How much does an SAT preparation course cost in Sharjah?</summary>
                        <div className="faq-accordion-content">
                            <p>SAT preparation course fees in Sharjah typically range from AED 1,800 to AED 4,000 depending on the course duration, batch size, and whether sessions are group or one-on-one. At Nitaq Academy, we offer flexible payment options and group discounts for students enrolling together. Contact us for the current batch schedule and pricing.</p>
                        </div>
                    </details>
                    <details className="faq-accordion">
                    ...
                    <details className="faq-accordion">
                        <summary>Are weekend SAT classes available in Sharjah?</summary>
                        <div className="faq-accordion-content">
