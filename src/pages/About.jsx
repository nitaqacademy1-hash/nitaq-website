        ...
        <main>
            ...
            <section className="section-padding" style={{
                ...
                <div className="container" style={{ position: 'relative', zIndex: 1 }}>
                    <div style={{ maxWidth: '800px', margin: '0 auto', textAlign: 'center' }}>
                        ...
                        <h1 style={{ fontSize: '4.5rem', marginBottom: '30px', lineHeight: 1.1, letterSpacing: '-0.04em', color: 'var(--text-dark)' }}>
                            Shaping the Future of <br />
                            <span className="text-gradient">Professional Education</span>
                        </h1>
                        <p style={{ fontSize: '1.4rem', color: 'var(--text-gray)', lineHeight: 1.6 }}>
            ...
            <section className="section-padding" style={{ background: 'var(--bg-white)' }}>
                <div className="container">
                    <div className="feature-block" style={{ alignItems: 'center', gap: '80px' }}>
                        ...
                        <div className="feature-img" style={{ position: 'relative' }}>
                            ...
                            <img
                                ...
                                style={{ width: '100%', height: '550px', objectFit: 'cover', borderRadius: '30px', position: 'relative', zIndex: 1, boxShadow: '0 30px 60px rgba(0,0,0,0.1)' }}
                            />
                        </div>
                    </div>
                </div>
            ...
            <section className="section-padding" style={{ background: 'var(--bg-light)' }}>
                <div className="container">
                    ...
                    <div className="contact-grid" style={{ gap: '40px' }}>
                        <div className="content-card" style={{ padding: '60px', textAlign: 'center', background: 'white' }}>
            ...
            <section className="section-padding" style={{ background: 'var(--bg-white)' }}>
                <div className="container">
                    <div style={{ textAlign: 'center', marginBottom: '80px' }}>
                        <h2 style={{ fontSize: '3.5rem', lineHeight: 1.1, marginBottom: '20px' }}>Why <span className="text-gradient">Nitaq?</span></h2>
                        ...
                        {[
                            ...
                            <div key={idx} style={{
                                ...
                                <div style={{
                                    ...
                                    marginBottom: '30px',
                                    border: `2px solid ${idx % 2 === 0 ? 'rgba(46, 125, 50, 0.2)' : 'rgba(43, 187, 173, 0.2)'}`
                                }}>
                                    <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                                        <path d={item.icon} />
                                    </svg>
                                </div>
                                <h3 style={{ fontSize: '1.5rem', marginBottom: '18px', color: 'var(--text-dark)', fontWeight: 700 }}>{item.title}</h3>
                                <p style={{ color: 'var(--text-gray)', lineHeight: 1.7, fontSize: '1.05rem' }}>{item.desc}</p>
                            </div>
                        ))}
                    </div>
                </div>
            ...
            <section className="section-padding" style={{ paddingBottom: '120px' }}>
                <div className="container">
                    <div className="testimonial-poster" style={{ background: 'var(--gradient-primary)', borderRadius: '40px', padding: '100px 60px' }}>
                        ...
                        <h2 style={{ fontSize: '3.5rem', color: 'white', marginBottom: '30px', position: 'relative', zIndex: 1 }}>Ready to join our community?</h2>
                        <p style={{ fontSize: '1.25rem', color: 'rgba(255,255,255,0.9)', maxWidth: '600px', margin: '0 auto 50px', position: 'relative', zIndex: 1 }}>
                            Take the first step towards academic and professional success today.
                        </p>
                        <div style={{ position: 'relative', zIndex: 1, display: 'flex', gap: '20px', justifyContent: 'center' }}>
